...
class TaskList extends StatefulWidget {
  ...
  TaskList({Key key, @required this.text, this.text2}) : super(key: key);
  @override
  _TaskListState createState() => new _TaskListState(text: text,text2: text2);
}
...
class _TaskListState extends State<TaskList> {
  ...
  _TaskListState({Key key, @required this.text, this.text2}) : super();
  final String uri =
          ...
          child: Stack(children: <Widget>[
            ...
            Card(
              ...
              child: Container(
                ...
                Visibility(visible:_TaskListState.attchCount==0?false:true ,child: Padding(
