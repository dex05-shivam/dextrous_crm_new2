...
class AddComments extends StatelessWidget {
  ...
  AddComments({Key key, @required this.text, this.text2}) : super(key: key);
  @override
...
class MyStatefulWidget extends StatefulWidget {
  ...
  MyStatefulWidget({Key key, @required this.text,this.text2}) : super(key: key);

  @override
  _MyStatefulWidgetState createState() => _MyStatefulWidgetState(text: text,text2: text2);
}
...
class _MyStatefulWidgetState extends State<MyStatefulWidget> {
  ...
  final String text,text2;
  ProgressDialog pr;
  _MyStatefulWidgetState({Key key, @required this.text,this.text2}) : super();

  final TextEditingController _comments = new TextEditingController();
  final String url =
      "http://ems.dextrousinfosolutions.com/dev-dexcrm/api/leads/lebelList";
  ...
  void getToekn() async {
    ...
    String login_url =
        "http://ems.dextrousinfosolutions.com/dev-dexcrm/api/leads/add_editLead_Comment";
    FormData formData = new FormData.from({
      "noteId": text2==['',null,""] ?' ':text2,
