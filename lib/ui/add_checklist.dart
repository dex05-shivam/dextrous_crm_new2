...
class AddCheckList extends StatelessWidget {
  ...
  AddCheckList({Key key, @required this.text, @required this.text2,this.text3}) : super(key: key);
  @override
  Widget build(BuildContext context) {
    return MaterialApp(
      debugShowCheckedModeBanner: false,
      home: Scaffold(
        body: AddCheckListWidget(
          text: text,
          text2: text2,
          text3: text3,
        ),
...
class AddCheckListWidget extends StatefulWidget {
  ...
  AddCheckListWidget({Key key, @required this.text,@required this.text2,this.text3}) : super(key: key);

  @override
  _AddCheckListState createState() => _AddCheckListState(text: text,text2: text2,text3:text3);
}

class _AddCheckListState extends State<AddCheckListWidget> {
  String _mySelection;

  String text,text2,text3='';
  ProgressDialog pr;
  _AddCheckListState({Key key, @required this.text, @required this.text2,@required this.text3}) : super();
  ...
  void getToekn() async {
    ...
    String login_url =
        "http://ems.dextrousinfosolutions.com/dev-dexcrm/api/tasks/addEditchecklist";
    FormData formData = new FormData.from({
      "check_id": text2==['',null,""] ?' ':text2,
                                ...
                                child: new Card(
                                  child: new GestureDetector(
                                    onTap: () {
                                      ...
                                      if(_comments.text.toString()==""||_comments.text.toString()=="Enter Here"){
                                        Fluttertoast.showToast(
